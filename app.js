...
(function(){
  ...
  window.exportXlsx=function(){
    ...
    const allocationDetails=source.budgets.map(row=>({Company:row.company,Period:row.month,Category:row.category,Description:row.description,'Budget (MMK)':amount(row.amount)}));
